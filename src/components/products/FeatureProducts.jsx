        ...
        <div className='w-full flex flex-wrap mx-auto'>
            ...
            <div className='w-full grid grid-cols-5 md-lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-6'>
                ...
                <div className='border group transition-all duration-500 hover:shadow-md hover:-mt-3'>
                    <div className='relative overflow-hidden'>
                        <div className='flex justify-center items-center absolute text-white w-[38px] h-[38px] rounded-full bg-red-500 font-semibold text-xs left-2 top-2'>34%</div>
                        <img className='sm:w-full w-full aspect-square' src='https://res.cloudinary.com/dn7ko6gut/image/upload/v1748151286/products/qzfdb94cg9gqxvqlcybn.webp' alt="product image" />
                        <ul className='flex transition-all duration-700 -bottom-10 justify-center items-center gap-2 absolute w-full group-hover:bottom-3'>
                            ...
                            <Link to='/product/details/Formal-Shirt-With-Purple-Colour' className='w-[38px] h-[38px] cursor-pointer bg-white flex justify-center items-center rounded-full hover:bg-[#7fad39] hover:text-white hover:rotate-[720deg] transition-all' ><FaEye /></Link>
                    ...
                    <div className='py-3 text-gray-700 px-2'>
                        <h2>Formal Shirt With purple colour grid with cotton degined...</h2>
                        <div className='flex justify-start items-center gap-3'>
